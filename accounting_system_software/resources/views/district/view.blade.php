...
<div class="card-inner">
    <a href="#" data-toggle="modal" data-target="#add" class="btn btn-primary">Add District</a>
    <p></p>
...
<td>
    <a data-toggle="modal" data-target="#deleteid" onclick="delid(<?php echo $row['did']?>)" class="btn btn-danger">Delete</a>
    <a data-toggle="modal" data-target="#updateid" onclick="upid('<?php echo $row['did']?>','<?php echo $row['district']?>')" class="btn btn-primary">Update</a>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
              ...
              <label>District</label>
            <input type="text" name="district" id="u_district" class="form-control form-control-sm"/>
...
function update(){
    var id=$('#did').val();
    var district=$('#u_district').val();
    var token=$('#u_token').val()
    $.ajax({
        url:'dr_update',
        method:'POST',
        data:{id:id,district:district,_token:token},
        success:function(){
         window.location.assign('dr');   
        }
    })
