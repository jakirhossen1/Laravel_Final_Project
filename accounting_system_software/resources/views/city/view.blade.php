...
<div class="card-inner">
    ...
    <a href="ct_pdf" class="btn btn-danger">PDF</a>
    <a href="ct_print" class="btn btn-success">Print</a>
    <p></p>
...
<td>
    ...
    <a data-toggle="modal" data-target="#updateid" onclick="upid('<?php echo $row['cid']?>','<?php echo $row['city_name']?>')" class="btn btn-primary">Update</a>
        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
              ...
              <input type="hidden" name="_token" id="_token" value="{{ csrf_token()}}">
               ...
               <select name="id" id="id" onkeyup="validation(id)" onchange="validation(id)" class="form-control form-select-sm">
                  <option value="">Please select Division</option>
                  <?php              foreach ($dv as $row){?>
                  <option value="<?php echo $row['id']?>"><?php echo $row['division_name']?></option>
                  <?php }?>
              </select>
               <label id="id_error" style="color:red"></label>
               <p></p>
              <label>District</label>
              <select name="did" id="did" class="form-control form-select-sm" onkeyup="validation(id)" onchange="validation(id)">
                  <option value="">Please select District</option>
                  <?php              foreach ($dr as $row){?>
                  <option value="<?php echo $row['did']?>"><?php echo $row['district']?></option>
                  <?php }?>
              </select>
               <label id="did_error" style="color:red"></label>
              <label>City</label>
            <input type="text" name="city_name" id="city_name" class="form-control form-control-sm" onkeyup="validation(id)" onchange="validation(id)"/>
...
function save(){
    ...
    if(division_id==='' || district_id==='' || city_name===''){
       if(division_id===''){
        $('#id_error').html("Please select division");
        $('#id').css('border-color','red');
       }
       if(district_id===''){
        $('#did_error').html("Please select district");
        $('#did').css('border-color','red');
       }
       if(city_name===''){
        $('#city_name_error').html("Please enter city");
